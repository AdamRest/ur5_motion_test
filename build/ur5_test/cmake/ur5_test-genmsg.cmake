...
message(STATUS "ur5_test: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iur5_test:/home/amr/ur_ws/src/ur5_ROS-Gazebo/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/amr/ur_ws/src/ur5_ROS-Gazebo/msg/target_pose.msg" NAME_WE)
add_custom_target(_ur5_test_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_test" "/home/amr/ur_ws/src/ur5_ROS-Gazebo/msg/target_pose.msg" "geometry_msgs/Pose:geometry_msgs/Point:geometry_msgs/Quaternion:std_msgs/Header"
)
...
### Generating Messages
_generate_msg_cpp(ur5_test
  "/home/amr/ur_ws/src/ur5_ROS-Gazebo/msg/target_pose.msg"
  "${MSG_I_FLAGS}"
...
get_filename_component(_filename "/home/amr/ur_ws/src/ur5_ROS-Gazebo/msg/target_pose.msg" NAME_WE)
add_dependencies(ur5_test_generate_messages_cpp _ur5_test_generate_messages_check_deps_${_filename})
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/amr/ur_ws/src/ur5_ROS-Gazebo/msg/target_pose.msg" NAME_WE)
add_dependencies(ur5_test_generate_messages_eus _ur5_test_generate_messages_check_deps_${_filename})
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/amr/ur_ws/src/ur5_ROS-Gazebo/msg/target_pose.msg" NAME_WE)
add_dependencies(ur5_test_generate_messages_lisp _ur5_test_generate_messages_check_deps_${_filename})
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/amr/ur_ws/src/ur5_ROS-Gazebo/msg/target_pose.msg" NAME_WE)
add_dependencies(ur5_test_generate_messages_nodejs _ur5_test_generate_messages_check_deps_${_filename})
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/amr/ur_ws/src/ur5_ROS-Gazebo/msg/target_pose.msg" NAME_WE)
add_dependencies(ur5_test_generate_messages_py _ur5_test_generate_messages_check_deps_${_filename})
...
if(TARGET geometry_msgs_generate_messages_cpp)
  add_dependencies(ur5_test_generate_messages_cpp geometry_msgs_generate_messages_cpp)
endif()
...
if(TARGET geometry_msgs_generate_messages_eus)
  add_dependencies(ur5_test_generate_messages_eus geometry_msgs_generate_messages_eus)
endif()
...
if(TARGET geometry_msgs_generate_messages_lisp)
  add_dependencies(ur5_test_generate_messages_lisp geometry_msgs_generate_messages_lisp)
endif()
...
if(TARGET geometry_msgs_generate_messages_nodejs)
  add_dependencies(ur5_test_generate_messages_nodejs geometry_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ur5_test)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ur5_test\")")
  # install generated code
  install(
...
if(TARGET geometry_msgs_generate_messages_py)
  add_dependencies(ur5_test_generate_messages_py geometry_msgs_generate_messages_py)
endif()
